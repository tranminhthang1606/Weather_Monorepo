...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/adk9pZoi96)
...
```sh
npx nx serve weather-monorepo-app
```

To create a production bundle:

```sh
npx nx build weather-monorepo-app
```

To see all available targets to run for a project, run:

```sh
npx nx show project weather-monorepo-app
```
